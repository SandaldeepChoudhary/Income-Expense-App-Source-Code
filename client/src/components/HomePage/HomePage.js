          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="relative mx-auto md:mr-0 max-w-max">
                <img
                  src="https://cdn.pixabay.com/photo/2019/02/15/19/10/investment-3999136_1280.jpg"
                  alt="home"
                />
              </div>
            </div>
      ...
      <section className="relative py-24 md:pb-32 bg-white overflow-hidden">
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            ...
            <a
              className="inline-flex items-center justify-center px-7 py-3 h-14 w-full md:w-auto text-lg leading-7 text-green-50 bg-blue-500 hover:bg-green-600 font-medium focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm"
              href="#"
            >
              Sign-Up
            </a>
          ...
          <div className="relative max-w-4xl mx-auto">
            <img
              className="relative"
              src="https://cdn.pixabay.com/photo/2019/09/27/17/02/rupee-4508945_1280.jpg"
              alt="landing"
            />
          </div>
        </div>
